package com.company.apirest.auth;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				.antMatchers(HttpMethod.GET, "/api/clientes", "/images/**", "/uploads/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/clientes/uploads/img/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/clientes/{id}").permitAll()
				.antMatchers(HttpMethod.GET, "/api/facturas/**").permitAll()
				.antMatchers(HttpMethod.GET, "/api/clientes/page/{page}").permitAll()
				/*
	 ...
	 * "OPTIONS")); config.setAllowCredentials(true);
